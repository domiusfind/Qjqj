...
--== CONFIG ==--
local webhookUrl = "https://discord.com/api/webhooks/1335825911794241637/NPFrLPKPpZ7fLg4L_MU4Ma87mXNL4UrKqGHMgQdc3BzM7yDCCm4mbKpQ2YPHHb-pmcC7" -- 🧠 Substitua pelo seu link do Webhook do Discord
...
local horarioFormatado = string.format("%02d:%02d do dia %02d/%02d/%04d", hora.hour, hora.min, hora.day, hora.month, hora.year)
...
local data = {
    ["embeds"] = {{
        ...
        ["description"] = "**Game name:**\n```" .. PlaceName .. "```\n\n" ..
                          "**Quantidade de Player:**\n```" .. playerCount .. "/" .. maxPlayers .. "```\n\n" ..
                          "**Job id:**\n```" .. JobId .. "```\n\n" ..
                          "**Horário:**\n```" .. horarioFormatado .. "```",
        ["color"] = tonumber(242429), -- Cor verde
        ["footer"] = {
            ["text"] = "discord.gg/domius | enviado às " .. string.format("%02d:%02d", hora.hour, hora.min)
        },
        ["author"] = {
